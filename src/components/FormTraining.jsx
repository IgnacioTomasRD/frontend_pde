    ...
    return <div id="form" className={styles.conteiner_training}>
        ...
        <div className={styles.conteiner_form}>   
            <form onSubmit={handleSubmit}>
                ...
                <input className={styles.input_formTraining} type="number" min={1} placeholder="en meses" name = "duration"></input>

                <label className={styles.formText} htmlFor="idays">Dias por semana </label>
                <input className={styles.input_formTraining} type="number" min={1} max ={7} name = "days"></input>
